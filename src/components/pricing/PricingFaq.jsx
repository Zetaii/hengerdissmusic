          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="aximo-default-content">
                ...
                <p>
                  We understand that you are considering our services, that's
                  why we’ve curated a collection of frequently asked questions.
                </p>
              </div>
              ...
              <div className="aximo-accordion-normal-wrap m_top_responsive">
                <div className="aximo-accordion-normal-item">
                  ...
                  <div className="aximo-accordion-normal-data">
                    <h3>Can I buy multiple songs?</h3>
                    <p>
                      Yes, you can get your consultation and request for
                      multiple songs. Our friendly team will work with you as
                      soon as possible.
                    </p>
                  </div>
                </div>
                ...
                <div className="aximo-accordion-normal-item">
                  ...
                  <div className="aximo-accordion-normal-data">
                    ...
                    <p>
                      ...
                      amount of work required. We offer a range of packages to
                      suit your needs.
                    </p>
                  </div>
                </div>
